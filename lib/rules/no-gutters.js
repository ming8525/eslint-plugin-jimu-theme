...
module.exports = {
  meta: {
    ...
    docs: {
      description:
        'This rule facilitates the deprecation of gutter variables in the theme and provides automatic fixes to replace these gutter variables with specific values.',
      recommended: false,

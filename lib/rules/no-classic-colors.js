'use strict'
const { isSpecifiedMemberExpressionNode, getMemberExpressionNodeOptinalObject, getColorVariableMappingInNewTheme, getSharedColorVariableMappingInNewTheme, ThemeAllColors, ThemeLightDarkColors, ThemePaletteShades } = require('../utils')

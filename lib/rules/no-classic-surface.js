  ...
  create(context) {
    return {
      MemberExpression(node) {
        ...
        let props = null
        if ((props = matchNodeIdentifiers(node, ['this', 'props', ['theme', 'theme2'], 'surfaces', ['1', '2'], ['bg', 'shadow']], variables))) {
          ...
          reportMessages(node, context, props)
        } else if ((props = matchNodeIdentifiers(node, ['this', 'props', ['theme', 'theme2'], 'surfaces', ['1', '2']], variables))) {

  ...
  create(context) {
    return {
      MemberExpression(node) {
        ...
        let props = null
        if ((props = matchNodeIdentifiers(node, ['this', 'props', 'theme', 'typography', 'variants', Object.keys(TypographyVariantsMap), Object.keys(TypographyStylesMap)], variables))) {
          ...
          reportMessages(node, context, props)
        } else if ((props = matchNodeIdentifiers(node, ['this', 'props', 'theme', 'typography', ['fontFamilyBase', 'fontSizeRoot', 'fontSizeBase']], variables))) {
          reportMessages(node, context, props)
        }
      }
    }

'use strict'
const { isSpecifiedMemberExpressionNode, getMemberExpressionNodeOptinalObject, getColorVariableMappingInNewTheme, ThemePaletteShades, ThemeLightDarkColors } = require('./utils')
